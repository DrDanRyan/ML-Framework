classdef Conv2DLayerRF < CompositeBaseLayer & ParamsFunctions & ...
                         matlab.mixin.Copyable
   % A convolution layer for multiple channels of 2D signals that randomly
   % selects a subset of the input channels for the receptive field of each
   % filter. The receptive field connections are randomly generated at
   % construction and stored in the connectionTable property.
   ...
   methods
      function obj = Conv2DLayerRF(inputRows, inputCols, nChannels, ...
                                   filterRows, filterCols, nFilters, ...
      ...
      function init_params(obj)
         ...
         if isempty(obj.initScale)
            obj.initScale = ...
               1/(obj.filterRows*obj.filterCols*obj.receptiveField);
         end
         obj.params{1} = 2*obj.initScale*obj.gpuState.rand(...
            obj.receptiveField, 1, obj.nFilters, obj.filterRows, ...
            obj.filterCols) - obj.initScale;
         ...
         obj.connectionTable = obj.gpuState.zeros(obj.receptiveField, ...
                                               obj.nChannels, obj.nFilters);
         ...
         for i = 1:yRows
            for j = 1:yCols
               xSample = shiftdim(x(:,:,i:i+obj.filterRows-1, ...
                               j:j+obj.filterCols-1), -1); % 1 X C x N x fR x fC
