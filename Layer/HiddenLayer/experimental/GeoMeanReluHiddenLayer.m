classdef GeoMeanReluHiddenLayer < StandardLayer & HiddenLayer
   ...
   methods
      function obj = GeoMeanReluHiddenLayer(inputSize, outputSize, D, varargin)
      ...
      function init_params(obj)
         obj.params{2} = log(.1)*obj.gpuState.ones(obj.outputSize, 1, obj.D);
         for d = 1:obj.D
      ...
      function value = compute_Dy(obj, z, y)
         value = bsxfun(@times, y, obj.gpuState.make_numeric(z < 0)/obj.D);
      end
